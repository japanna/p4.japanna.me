...
# Default DB name for this app
	define('DB_NAME', 'japannab_p4_japanna_me'); 
...
# For extra security, you might want to set different salts than what the core uses
	define('PASSWORD_SALT', 'tyc99jPzswbhRqg8lMb)qeF7AJUhz36KVj^a60t_');
	define('TOKEN_SALT', 'VCpL3op*-h6y6T@C(E)kH9Zd%49GwheSAbMfr^7D');